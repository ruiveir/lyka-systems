 ...
 *   https://datatables.net/download/#bs4/dt-1.10.21/r-2.2.5/sc-2.0.2/sp-1.1.1
 *
 * Included libraries:
 *   DataTables 1.10.21, Responsive 2.2.5, Scroller 2.0.2, SearchPanes 1.1.1
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs4/dt-1.10.21/r-2.2.5/sc-2.0.2/sp-1.1.1",
