...
Route::group(['middleware' => ['auth', 'PreventBackHistory']], function () {
	...
	/* Fase /
	Route::get('/produto/{produtoId}/fase', 'FaseController@list')->name('fase.list');
	Route::get('/produto/{produtoId}/fase/{faseId}', 'FaseController@get')->name('fase.get');
	Route::post('/produto/{produtoId}/fase', 'FasestockController@create')->name('fase.create');
	Route::post('/produto/{produtoId}/fase/{faseId}', 'FasestockController@update')->name('fase.update');
	Route::delete('/produto/{produtoId}/fase/{faseId}', 'FasestockController@destroy')->name('fase.destroy');
	*/
