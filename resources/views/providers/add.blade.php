...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h4 mb-0 text-gray-800">Novo fornecedor</h1>
	...
	<div class="card shadow mb-4">
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-primary">Formulário - Criação de um fornecedor</h6>
		</div>
		<div class="card-body">
			<form class="form-group needs-validation" novalidate action="{{route('provider.store')}}" method="POST">
				@csrf
				<div class="container-fluid">
					...
					<div class="text-right mt-3" id="groupBtn">
						...
						<button type="submit" name="button" class="btn btn-primary text-white font-weight-bold" id="submitbtn">Registar fornecedor</button>
					</div>
				</div>
			</form>
		</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body text-gray-800 pl-4 pr-5">
				Ao preencher o formulário e submete-lo irá criar um novo fornecedor. Os campos com o asterisco de cor vermelha são de preenchimento obrigatório.
			</div>
...
<!-- Begin of Scripts -->
@section('scripts')
	<script src="{{asset('/js/providers/add.js')}}"></script>
@endsection
<!-- End of Scripts -->
@endsection
<!-- End of Page Content -->
