...
<!-- Page Title -->
@section('title', 'Edição conta bancária')
<!-- Page Content -->
@section('content')
<!-- Begin Page Content -->
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h4 mb-0 text-gray-800">Editar conta bancária</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Formulário - Edição conta bancária ({{$conta->descricao}})</h6>
        </div>
        <div class="card-body">
            <form class="form-group needs-validation" novalidate action="{{route('conta.update', $conta)}}" method="POST">
                @csrf
                @method("PUT")
                <div class="container-fluid">
                    ...
                    <div class="text-right mt-3" id="groupBtn">
                        ...
                        <button type="submit" name="button" class="btn btn-primary text-white font-weight-bold" id="submitbtn">Editar conta bancária</button>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body text-gray-800 pl-4 pr-5">
                Ao preencher o formulário irá editar o registo de uma conta bancária. Os campos com o asterisco de cor vermelha são de preenchimento obrigatório.
            </div>
...
<!-- Begin of Scripts -->
@section('scripts')
	<script src="{{asset('/js/conta/edit.js')}}"></script>
@endsection
<!-- End of Scripts -->
@endsection
<!-- End of Page Content -->
