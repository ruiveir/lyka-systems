...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h4 mb-0 text-gray-800">Editar contacto</h1>
			...
			<form class="form-group needs-validation" action="{{route('contacts.update', $contact)}}" method="POST" novalidate enctype="multipart/form-data">
				...
				<div class="container-fluid">
					...
					<div class="text-right mt-3" id="groupBtn">
						...
						<button type="submit" name="button" class="btn btn-primary text-white font-weight-bold" id="submitbtn">Editar contacto</button>
					</div>
				</div>
			</form>
		</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body text-gray-800 pl-4 pr-5">
				Ao preencher o formulário irá editar o contacto. Os campos com o asterisco de cor vermelha são de preenchimento obrigatório.
			</div>
...
<!-- Begin of Scripts -->
@section('scripts')
	<script src="{{asset('/js/contacts/edit.js')}}"></script>
@endsection
<!-- End of Scripts -->
@endsection
<!-- End of Page Content -->
