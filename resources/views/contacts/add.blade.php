...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		@if(isset($university))
			<h1 class="h4 mb-0 text-gray-800">Novo contacto ({{$university->nome}})</h1>
		@else
			<h1 class="h4 mb-0 text-gray-800">Novo contacto</h1>
		@endif
			...
			<form class="form-group needs-validation" action="{{route('contacts.store')}}" method="POST" novalidate enctype="multipart/form-data">
				...
				<div class="container-fluid">
					...
					<div class="text-right mt-3" id="groupBtn">
						...
						<button type="submit" name="button" class="btn btn-primary text-white font-weight-bold" id="submitbtn">Registar contacto</button>
					</div>
				</div>
			</form>
		</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body text-gray-800 pl-4 pr-5">
				Ao preencher o formulário irá criar um novo contacto. Os campos com o asterisco de cor vermelha são de preenchimento obrigatório.
			</div>
...
<!-- Begin of Scripts -->
@section('scripts')
	<script src="{{asset('/js/contacts/add.js')}}"></script>
@endsection
<!-- End of Scripts -->
@endsection
<!-- End of Page Content -->
