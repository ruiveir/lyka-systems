...
<head>
    ...
    <title> Não encontrado - Lyka Systems</title>
            ...
            <div class="col text-center border-danger" style="width:500px">
                ...
                <div class="row">
                    <div class="col mr-4 card rounded-lg p-5 shadow">
                        <div class="text-danger" style="text-transform: uppercase; font-size:40px">Erro 404</div><br>
                        <div><strong>A página que procura não foi encontrada</strong><br><small >Se o problema persistir, contacte o administrador</small></div>
