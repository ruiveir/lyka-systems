...
<head>
    ...
    <title> Não autorizado - Lyka Systems</title>
            ...
            <div class="col text-center border-danger" style="width:500px">
                ...
                <div class="row">
                    <div class="col mr-4 card rounded-lg p-5 shadow">
                        <div class="text-danger" style="text-transform: uppercase; font-size:40px">Erro 401</div><br>
                        <div><strong>Não está autorizado a consultar esta página.</strong><br><small >Para mais informações contacte o administrador</small></div>
