...
<!-- Page Title -->
@section('title', 'Relatório e contas')
<!-- Page Content -->
@section('content')
<!-- Begin Page Content -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body text-gray-800 pl-4 pr-5">
                Nesta secção encontra-se os dados estatísticos da Estudar Portugal. Pode gerar um relatório completo clicando no botão <b>Gerar relatório</b>.
            </div>
