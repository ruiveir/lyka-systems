<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div>
        <a href="{{route('payments.edituni2', [$universidade2, $fase, $responsabilidade, $pagoResponsabilidade])}}" class="btn btn-success btn-icon-split btn-sm" title="Editar">
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Visualização do pagamento sobre a fase {{$fase->descricao}} da universidade {{$universidade2->nome}}.</h6>
    </div>
    <div class="card-body">
        <div class="row">
            <div class="col-md-6">
