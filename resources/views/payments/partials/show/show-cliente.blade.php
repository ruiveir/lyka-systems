<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div>
        <a href="{{route('payments.editcliente', [$responsabilidade->cliente, $responsabilidade->fase, $responsabilidade, $responsabilidade->pagoResponsabilidade])}}" class="btn btn-success btn-icon-split btn-sm" title="Editar">
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Visualização do pagamento sobre a fase {{$fase->descricao}} do cliente {{$fase->produto->cliente->nome.' '.$fase->produto->cliente->apelido}}.</h6>
    </div>
    <div class="card-body">
        <div class="row">
            <div class="col-md-6">
        ...
        <div class="row">
            <div class="col-md-6">
                <p class="text-gray-800 text-truncate"><b>Comprovativo de pagamento:</b> @if($pagoResponsabilidade->comprovativoPagamento != null) <a href="{{route("payments.downloadComprovativo", $pagoResponsabilidade)}}">{{$pagoResponsabilidade->comprovativoPagamento}}</a> @else N/A @endif</p>
            </div>
            <div class="col-md-6">
