<div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary text-truncate" title="Formulário de edição do pagamento sobre a fase {{$fase->descricao}} do agente {{$fase->produto->agente->nome.' '.$fase->produto->agente->apelido}}.">Formulário de edição do pagamento sobre a fase "{{$fase->descricao}}" do agente {{$fase->produto->agente->nome.' '.$fase->produto->agente->apelido}}.</h6>
</div>
<div class="card-body">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="custom-file mb-3">
                        @if($pagoResponsabilidade->comprovativoPagamento)
                            <input type="file" class="custom-file-input" name="comprovativoPagamentoAgente" id="comprovativoPagamentoAgente" title="{{old("comprovativoPagamento", $pagoResponsabilidade->comprovativoPagamento)}}">
