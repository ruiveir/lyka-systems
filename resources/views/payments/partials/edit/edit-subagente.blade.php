            ...
            <div class="form-row mb-3">
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" name="valorPagoSubAgente" id="valorPagoSubAgente" aria-describedby="validatedInputGroupPrepend" value="{{old('valorPagoSubAgente', number_format((float)$pagoResponsabilidade->valorPago, 2, ',', ''))}}" required>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="custom-file mb-3">
                        @if($pagoResponsabilidade->comprovativoPagamento)
                            <input type="file" class="custom-file-input" name="comprovativoPagamentoSubAgente" id="comprovativoPagamentoSubAgente" title="{{old("comprovativoPagamento", $pagoResponsabilidade->comprovativoPagamento)}}">
