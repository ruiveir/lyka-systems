<div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary">Formulário de edição do pagamento sobre a fase {{$fase->descricao}} do cliente {{$fase->produto->cliente->nome.' '.$fase->produto->cliente->apelido}}.</h6>
</div>
<div class="card-body">
