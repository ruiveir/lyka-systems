<div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary text-truncate" title="Formulário de edição do pagamento sobre a fase {{$fase->descricao}} do cliente {{$fase->produto->cliente->nome.' '.$fase->produto->cliente->apelido}}.">Formulário de edição do pagamento sobre a fase "{{$fase->descricao}}" do cliente {{$fase->produto->cliente->nome.' '.$fase->produto->cliente->apelido}}.</h6>
</div>
<div class="card-body">
            ...
            <div class="form-row mb-3">
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" name="valorPagoCliente" id="valorPagoCliente" aria-describedby="validatedInputGroupPrepend" value="{{old('valorPagoCliente', number_format((float)$pagoResponsabilidade->valorPago, 2, ',', ''))}}" required>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="custom-file mb-3">
                        @if($pagoResponsabilidade->comprovativoPagamento)
                            <input type="file" class="custom-file-input" name="comprovativoPagamentoCliente" id="comprovativoPagamentoCliente" title="{{old("comprovativoPagamento", $pagoResponsabilidade->comprovativoPagamento)}}">
