<div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary text-truncate" title="Formulário de edição do pagamento sobre a fase {{$fase->descricao}} da universidade {{$fase->produto->universidade2->nome}}">Formulário de edição do pagamento sobre a fase "{{$fase->descricao}}" da universidade {{$fase->produto->universidade2->nome}}.</h6>
</div>
<div class="card-body">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="custom-file mb-3">
                        @if($pagoResponsabilidade->comprovativoPagamento)
                            <input type="file" class="custom-file-input" name="comprovativoPagamentoUni2" id="comprovativoPagamentoUni2" title="{{old("comprovativoPagamento", $pagoResponsabilidade->comprovativoPagamento)}}">
