...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h4 mb-0 text-gray-800">Editar administrador</h1>
			...
			<form class="form-group needs-validation" action="{{route('admin.update', $admin)}}" method="POST" novalidate>
				...
				<div class="container-fluid">
					...
					<div class="text-right mt-3" id="groupBtn">
						...
						<button type="submit" name="button" class="btn btn-primary text-white font-weight-bold" id="submitbtn">Editar administrador</button>
					</div>
				</div>
			</form>
		</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body text-gray-800 pl-4 pr-5">
				Ao preencher o formulário irá editar um administrador. Os campos com o asterisco de cor vermelha são de preenchimento obrigatório.
			</div>
